...
namespace tapete
{
	partial class cantidad
	{
		...
		private void InitializeComponent()
		{
			...
			// textBox7
			// 
			this.textBox7.Location = new System.Drawing.Point(194, 341);
			...
			// textBox6
			// 
			this.textBox6.Location = new System.Drawing.Point(194, 303);
			...
			// textBox4
			// 
			this.textBox4.Location = new System.Drawing.Point(194, 190);
			...
			// label9
			// 
			this.label9.Location = new System.Drawing.Point(50, 384);
			...
			this.label8.Text = "Precio de los alimentos";
			// 
			// label7
			// 
			...
			this.label7.Text = "Tiempo de diseño (hrs)";
			// 
			// label6
			// 
			...
			this.label5.Text = "Precio de docena de flores";
			// 
			// label4
			// 
			...
			this.label4.Text = "Precio de Frutos secos (Kg)";
			// 
			// label3
			// 
			...
			this.label3.Text = "Precio de la Pintura";
			// 
			// label2
			// 
			...
			this.label2.Text = "Precio del bulto de aserrín";
			// 
			// label1
			// 
			...
			// textBox9
			// 
			this.textBox9.Location = new System.Drawing.Point(194, 262);
